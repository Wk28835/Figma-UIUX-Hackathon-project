...
<div>
    ...
    style={{width:"1100px",height:"632.89px",top:"40px",left:"155.5px",position:"relative"}}>
        
        <section className="lg:w-2/3 rounded-md"
        style={{width:"733.33px",height:"547.89px"}}>
          ...
          <p
          style={{width:"88px",height:"14px",top:"16px",bottom:"6px",left:"18px",position:"relative",
            fontSize:"13px",lineHeight:"14px",fontWeight:"500" }}>
              Free Delivery
            </p>

            <p className="text-nowrap"
          style={{width:"213px",height:"24px",top:"20px",bottom:"8px",left:"18px",position:"relative",
            fontSize:"11px",lineHeight:"24px",fontWeight:"500" }}>
             Applies to orders of ₹ 14 000.00 or more.
            </p>

            <p className="text-nowrap underline"
          style={{width:"64px",height:"24px",top:"-3px",left:"232px",position:"relative",
            fontSize:"11px",lineHeight:"24px",fontWeight:"500" }}>
             View details
            </p> 
           ...
           style={{width:"717.33px",height:"436px",top:"60.89px",left:"8px",position:"relative",
            paddingTop:"24px",paddingBottom:"24px", boxShadow:"0.2%"}}>
              ...
              <div className="gap-8 mainproduct1 div flex"
              style={{width:"717.33px",height:"170px" }}>
                ...
                style={{width:"537.33px",height:"170px"}}>
                  ...
                  style={{width:"537.33px",height:"64px",paddingTop:"36px",paddingRight:"473.33px",position:"relative",
                    paddingBottom:"6px"}}>

                    <Image width={24} height={24} alt="image"
                    style={{top:"3.75px",left:"2.25px",borderWidth:"1.5px",
                      position:"relative"}}
                      src="/heart.png"
                    />

                <Image width={24} height={24} alt="image"
                    style={{top:"3.75px",left:"20px",borderWidth:"1.5px",
                      position:"relative"}}
                      src="/recyclebin.png"
                    />
                  </div>
              ...
              <div className="gap-8 mainproduct2 mt-8 div flex"
              style={{width:"717.33px",height:"170px" }}>

                
                <div className="gap-6 ml-44"
                style={{width:"537.33px",height:"170px"}}>
                  ...
                  style={{width:"173px",height:"28px",top:"1.89px",right:"120px",position:"relative",
                    ...
                    <p className="text-gray-600"
                  style={{width:"173px",height:"28px",top:"1.89px",right:"240px",position:"relative",
                    fontSize:"15px",fontWeight:"400",lineHeight:"28px"}}>Quantity<span className="mx-4">1</span></p>
                ...
                <Image width={24} height={24} alt="image"
                    style={{top:"3.75px",left:"20px",borderWidth:"1.5px",position:"relative"}}
                      src="/recyclebin.png"
                    />
                  </div>
