...
const Footer: React.FC = () => {
  ...
  return (
    <div style={{top:"1450px",position:"absolute"}}>

     
        <div className="main div bg-black text-white"
        style={{width:"1440px",height:"331px"}}>

        <section className="flex"
         style={{width:"1372px",height:"213px",marginLeft:"34px",marginTop:"40px"}}>

          <div style={{width:"245.25px",height:"169.63px",left:"6px"}}>
            <ul>
              <li className="text-nowrap ml-4" 
              style={{width:"68.62px",height:"16px",paddingTop:"40px",fontSize:"10px",lineHeight:"32.67px"}}>
                FIND A STORE</li>
              <li className="text-nowrap ml-4"
               style={{width:"98.17px",height:"16px",paddingTop:"36px",fontSize:"10px",lineHeight:"32.67px"}}>
                BECOME A MEMBER</li>
          ...
          <div style={{width:"245.25px",height:"169.63px",left:"6px"}}>
            <ul>
              ...
              style={{width:"68.62px",height:"16px",paddingTop:"40px",fontSize:"10px",lineHeight:"32.67px"}}>
                GET HELP</li>
              <li className="text-nowrap ml-4 text-gray-500"
               style={{width:"98.17px",height:"16px",paddingTop:"36px",fontSize:"10px",lineHeight:"32.67px"}}>
                Order Status</li>
               ...
               style={{width:"98.17px",height:"16px",paddingTop:"36px",fontSize:"10px",lineHeight:"32.67px"}}>
                ...
                <li className="text-nowrap ml-4 text-gray-500"
               style={{width:"98.17px",height:"16px",paddingTop:"36px",fontSize:"10px",lineHeight:"32.67px"}}>
                Contact Us On Nike.com inquires</li>

                <li className="text-nowrap ml-4 text-gray-500"
               style={{width:"98.17px",height:"16px",paddingTop:"36px",fontSize:"10px",lineHeight:"32.67px"}}>
                Contact Us On All Other inquires</li>
            </ul>
          ...
          <div style={{width:"245.25px",height:"169.63px",left:"6px"}}>
            ...
            <div className="mx-4" style={{width:"337px",height:"37px", marginLeft:"512px"}}>
              <button className="mx-2">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="black" className="w-8 h-8 rounded-full bg-gray-500">
              ...
              <button className="mx-2">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="black" className="w-8 h-8 rounded-full bg-gray-500 p-2 text-center mt-10">
              ...
              <button className="mx-2"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="black" className="w-8 h-8 rounded-full bg-gray-500 p-2 text-center mt-10">
